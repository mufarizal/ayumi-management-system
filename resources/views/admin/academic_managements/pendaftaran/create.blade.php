...
@section('content')
        ...
        <div class="md:ml-64 p-4 md:p-8">
            ...
            <div class="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-bold text-gray-800 leading-tight">Tambah Pendaftaran</h1>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="px-6 py-4"
                    ...
                    <h2 class="text-xl font-bold text-white">Form Pendaftaran Baru</h2>
                    <span class="text-gray-200 text-sm">Semua field bertanda * wajib diisi</span>
                </div>

                <form action="{{ route('admin.pendaftaran.store') }}" method="POST" class="p-6 md:p-8">
                    @csrf
    ...
    <script>
        ...
        // Filter kelas berdasarkan program yang dipilih
        ...
        if (programSelect.value) {
            ...
            // Restore selected kelas setelah filter
