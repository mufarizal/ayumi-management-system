        ...
        <div class="md:ml-64 p-4 md:p-8">
            ...
            <div class="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-bold text-gray-800 leading-tight">Tambah Program</h1>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="px-6 py-4"
                    ...
                    <h2 class="text-xl font-bold text-white">Form Program Baru</h2>
                    <span class="text-gray-200 text-sm">Semua field bertanda * wajib diisi</span>
                </div>

                <form action="{{ route('admin.program.store') }}" method="POST" class="p-6 md:p-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-5 top-1/2 -translate-y-1/2 text-sm font-semibold text-gray-400 pointer-events-none">Rp</span>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="deskripsi" rows="5"
                                placeholder="Tuliskan deskripsi program (opsional)..."
                                class="w-full px-5 py-3 rounded-xl text-sm border @error('deskripsi') border-red-400 bg-red-50 @else border-gray-200 @enderror focus:outline-none focus:border-[#87010e] bg-white shadow-sm transition-colors resize-none">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="mt-2 text-xs text-red-500 flex items-center gap-1">
                                    <i data-lucide="alert-circle" class="w-3 h-3"></i> {{ $message }}
                                </p>
