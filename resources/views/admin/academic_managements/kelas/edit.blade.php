        ...
        <div class="md:ml-64 p-4 md:p-8">
            ...
            <div class="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-bold text-gray-800 leading-tight">Edit Kelas</h1>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="px-6 py-4"
                    ...
                    <span class="text-gray-200 text-sm">ID #{{ $kelas->id }} &nbsp;·&nbsp; Semua field bertanda * wajib
                        diisi</span>
                </div>

                <form action="{{ route('admin.kelas.update', $kelas) }}" method="POST" class="p-6 md:p-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="program_id"
                                ...
                                @foreach (\App\Models\Program::orderBy('nama_program')->get() as $program)
                                    <option value="{{ $program->id }}"
                                        {{ old('program_id', $kelas->program_id) == $program->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_selesai"
                                value="{{ old('tanggal_selesai', \Carbon\Carbon::parse($kelas->tanggal_selesai)->format('Y-m-d')) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="status"
                                ...
                                <option value="nonaktif"
                                    {{ old('status', $kelas->status) === 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
                            @error('status')
                                <p class="mt-2 text-xs text-red-500 flex items-center gap-1">
                                    <i data-lucide="alert-circle" class="w-3 h-3"></i> {{ $message }}
