        ...
        <div class="md:ml-64 p-4 md:p-8">
            ...
            <nav class="text-sm mb-6" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <span class="text-gray-500">Tambah Siswa</span>
                    </li>
                </ol>
            </nav>
            ...
            <div class="">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    <div class="px-6 py-4"
                        ...
                        <h2 class="text-xl font-bold text-white">Form Tambah Siswa</h2>
                    </div>
                        ...
                        <form action="{{ route('admin.siswa.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="grid grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama_institusi" value="{{ old('institusi') }}"
                                        class="w-full px-4 py-3 rounded-xl text-sm border border-gray-200 focus:outline-none focus:border-[#87010e] bg-white transition-colors"
