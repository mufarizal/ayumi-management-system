            ...
            <nav class="text-sm mb-6" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    <li class="flex items-center">
                        <a href="{{ route('admin.siswa.index') }}" class="text-gray-500 hover:text-gray-700">siswa</a>
                    ...
                    <li class="flex items-center">
                        <span class="text-gray-500">Edit siswa</span>
                    </li>
                </ol>
            </nav>
            ...
            <div class="">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    <div class="px-6 py-4"
                        ...
                        <h2 class="text-xl font-bold text-white">Form Edit siswa</h2>
                    </div>
                        ...
                        <form action="{{ route('admin.siswa.update', $siswa->id) }}" method="POST"
                            ...
                            <div class="grid grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" value="{{ $siswa->user->name }}" readonly
                                ...
                                <div>
                                    ...
                                    <input type="email" value="{{ $siswa->user->email }}" readonly
                                        class="w-full px-4 py-3 rounded-xl text-sm border border-gray-200 bg-gray-100 cursor-not-allowed">
                                </div>
                            </div>

                            <div class="flex items-center">
                                <h1 class="w-36  font-semibold text-gray-700">Data siswa</h1>
                            ...
                            <div class="grid grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="no_telp" value="{{ old('no_telp', $siswa->no_telp) }}"
                                        required
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama_institusi"
                                        value="{{ old('nama_institusi', $siswa->nama_institusi) }}"
                                        class="w-full px-4 py-3 rounded-xl text-sm border border-gray-200 focus:outline-none focus:border-[#87010e] bg-white transition-colors"
                                ...
                                <div class="">
                                    ...
                                    <input type="hidden" name="is_active" value="{{ $siswa->is_active }}">
                                    {{-- hanya untuk tampilan --}}
                                    <input type="text" value="{{ $siswa->user->is_active ? 'Aktif' : 'Non Aktif' }}"
                                        readonly
                                        class="w-full px-4 py-3 rounded-xl text-sm border border-gray-200 bg-gray-100 cursor-not-allowed">
                                </div>
