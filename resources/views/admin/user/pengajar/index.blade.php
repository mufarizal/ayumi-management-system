                ...
                <div class="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-3 ">
                        ...
                        <div
                            ...
                            <i data-lucide="graduation-cap" class="w-5 h-5 text-gray-800"></i>
                        </div>
                    ...
                    <table class="w-full" style="min-width: 920px;">
                        <thead style="background: linear-gradient(to right, #6b0f1a, #8f1d2c);">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-sm font-semibold text-white">Level Bahasa</th>
                            ...
                            @forelse ($pengajar as $index => $pengajar)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 flex items-center gap-2">
                                        {{-- VIEW --}}
                                        <a href="{{ route('admin.pengajar.show', encrypt($pengajar->id)) }}"
                                        ...
                                        {{-- @if ($pengajar->is_active)
                                            <form action="{{ route('admin.pengajar.destroy', $pengajar->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')

                                                <button
                                                    class="p-2 rounded-lg text-gray-500 hover:text-white hover:bg-red-500"
